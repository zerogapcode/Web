// ========================================
    ...
    // ========================================
    const translations = {
      nav_home: { en: "Home", es: "Inicio", pt: "Início" },
      nav_services: { en: "Services", es: "Servicios", pt: "Serviços" },
      nav_departments: { en: "Departments", es: "Departamentos", pt: "Departamentos" },
      nav_contact: { en: "Contact", es: "Contacto", pt: "Contato" },
      nav_about: { en: "About", es: "Acerca", pt: "Sobre" },
      mode_auto: { en: "Auto", es: "Auto", pt: "Auto" },
      mode_light: { en: "Light", es: "Claro", pt: "Claro" },
      mode_dark: { en: "Dark", es: "Oscuro", pt: "Escuro" },
      hero_subtitle: { en: "Cutting-edge engineering for ambitious projects.", es: "Ingeniería de vanguardia para proyectos ambiciosos.", pt: "Engenharia de ponta para projetos ambiciosos." },
      hero_p1: { 
        ...
        pt: "Transformamos ideias complexas em produtos prontos para o mercado. Como um laboratório de inovação tecnológica, dominamos o desenvolvimento de aplicativos multiplataforma (iOS, Android, Windows, macOS, Linux), arquitetura web escalável e integração de sistemas eletrônicos."
      },
      hero_p2: { 
        ...
        pt: "Projetamos, desenvolvemos e construímos. Nossa abordagem end-to-end garante que cada linha de código e componente físico trabalhe em perfeita sincronia para impulsionar a sua visão."
      },
      services_title: { en: "Services", es: "Servicios", pt: "Serviços" },
      services_lead: { en: "Custom development, technical consulting, and rapid prototyping. We transform ideas into functional products.", es: "Desarrollo a medida, consultoría técnica y prototipado rápido. Transformamos ideas en productos funcionales.", pt: "Desenvolvimento sob medida, consultoria técnica e prototipagem rápida. Transformamos ideias em produtos funcionais." },
      service_ios_title: { en: "Multiplatform Development", es: "Desarrollo Multiplataforma", pt: "Desenvolvimento Multiplataforma" },
      service_ios_desc: { en: "Native and cross-platform applications for iOS, Android, Windows, macOS, and Linux. Optimized interfaces and exceptional user experience across all devices.", es: "Aplicaciones nativas y multiplataforma para iOS, Android, Windows, macOS y Linux. Interfaces optimizadas y experiencia de usuario excepcional en todos los dispositivos.", pt: "Aplicativos nativos e multiplataforma para iOS, Android, Windows, macOS e Linux. Interfaces otimizadas e experiência de usuário excepcional em todos os dispositivos." },
      service_web_title: { en: "Web Solutions", es: "Soluciones Web", pt: "Soluções Web" },
      service_web_desc: { en: "Development of modern web applications, RESTful APIs, and scalable backend systems with the latest technologies. Robust and maintainable architectures.", es: "Desarrollo de aplicaciones web modernas, APIs RESTful y sistemas backend escalables con las últimas tecnologías. Arquitecturas robustas y mantenibles.", pt: "Desenvolvimento de aplicações web modernas, APIs RESTful e sistemas backend escaláveis com as tecnologias mais recentes. Arquiteturas robustas e de fácil manutenção." },
      service_hw_title: { en: "Hardware/Software Integration", es: "Integración Hardware/Software", pt: "Integração Hardware/Software" },
      service_hw_desc: { en: "Embedded systems, IoT, automation, and physical device control via custom software. Seamless connection between the digital and physical worlds.", es: "Sistemas embebidos, IoT, automatización y control de dispositivos físicos mediante software personalizado. Conexión perfecta entre mundo digital y físico.", pt: "Sistemas embarcados, IoT, automação e controle de dispositivos físicos por meio de software personalizado. Conexão perfeita entre o mundo digital e o físico." },
      service_3d_title: { en: "Additive Manufacturing", es: "Fabricación Aditiva", pt: "Manufatura Aditiva" },
      service_3d_desc: { en: "Rapid prototyping, custom parts, and 3D printing solutions for hardware projects and physical products. From concept to final product.", es: "Prototipado rápido, piezas personalizadas y soluciones de impresión 3D para proyectos de hardware y productos físicos. Desde concepto hasta producto final.", pt: "Prototipagem rápida, peças personalizadas e soluções de impressão 3D para projetos de hardware e produtos físicos. Do conceito ao produto final." },
      service_consulting_title: { en: "Technical Consulting", es: "Consultoría Técnica", pt: "Consultoria Técnica" },
      service_consulting_desc: { en: "Specialized advice on software architecture, process optimization, and technology strategies. We maximize the value of your technological investment.", es: "Asesoramiento especializado en arquitectura de software, optimización de procesos y estrategias tecnológicas. Maximizamos el valor de tu inversión tecnológica.", pt: "Aconselhamento especializado em arquitetura de software, otimização de processos e estratégias de tecnologia. Maximizamos o valor do seu investimento tecnológico." },
      service_maintenance_title: { en: "Maintenance & Support", es: "Mantenimiento & Soporte", pt: "Manutenção & Suporte" },
      ...
      dept_elec_title: { en: "Electronics & IoT", es: "Electrónica & IoT", pt: "Eletrônica & IoT" },
      dept_elec_desc: { en: "Circuit design, embedded systems, sensors, and connectivity. Bridge between the digital and physical worlds, creating tangible and innovative solutions.", es: "Diseño de circuitos, sistemas embebidos, sensores y conectividad. Puente entre el mundo digital y físico, creando soluciones tangibles e innovadoras.", pt: "Design de circuitos, sistemas embarcados, sensores e conectividade. Ponte entre o mundo digital e o físico, criando soluções tangíveis e inovadoras." },
      dept_design_title: { en: "Design & UX/UI", es: "Diseño & UX/UI", pt: "Design & UX/UI" },
      dept_design_desc: { en: "Intuitive interfaces, optimized user experience, and attractive visual design for all our products. Focused on usability and aesthetics.", es: "Interfaces intuitivas, experiencia de usuario optimizada y diseño visual atractivo para todos nuestros productos. Centrados en la usabilidad y estética.", pt: "Interfaces intuitivas, experiência de usuário otimizada e design visual atraente para todos os nossos produtos. Foco em usabilidade e estética." },
      dept_fab_title: { en: "Manufacturing & Prototyping", es: "Fabricación & Prototipado", pt: "Manufatura & Prototipagem" },
      dept_fab_desc: { en: "3D printing, CNC machining, and fabrication of functional prototypes for concept validation. Materialization of ideas into physical products.", es: "Impresión 3D, mecanizado CNC y fabricación de prototipos funcionales para validación de conceptos. Materialización de ideas en productos físicos.", pt: "Impressão 3D, usinagem CNC e fabricação de protótipos funcionais para validação de conceitos. Materialização de ideias em produtos físicos." },
      dept_qa_title: { en: "Quality Control", es: "Control de Calidad", pt: "Controle de Qualidade" },
      dept_qa_desc: { en: "Exhaustive testing, test automation, and quality assurance at every stage of development. Committed to excellence and reliability.", es: "Testing exhaustivo, automatización de pruebas y garantía de calidad en cada etapa del desarrollo. Comprometidos con la excelencia y fiabilidad.", pt: "Testes exaustivos, automação de testes e garantia de qualidade em cada etapa do desenvolvimento. Comprometidos com a excelência e confiabilidade." },
      contact_title: { en: "Contact", es: "Contacto", pt: "Contato" },
      contact_lead: { en: "Do you have a project in mind? Let's talk about how we can make it happen.", es: "¿Tienes un proyecto en mente? Hablemos sobre cómo podemos hacerlo realidad.", pt: "Tem um projeto em mente? Vamos conversar sobre como podemos torná-lo realidade." },
      contact_info_title: { en: "Contact Information", es: "Información de Contacto", pt: "Informações de Contato" },
      contact_phone: { en: "Phone:", es: "Teléfono:", pt: "Telefone:" },
      contact_msg: { en: "Send message", es: "Enviar mensaje", pt: "Enviar mensagem" },
      contact_btn: { en: "CONTACT", es: "CONTACTO", pt: "CONTATO" },
      contact_hours_title: { en: "Business Hours", es: "Horario de Atención", pt: "Horário de Atendimento" },
      contact_mon_fri: { en: "Monday to Friday:", es: "Lunes a Viernes:", pt: "Segunda a Sexta:" },
      contact_sat: { en: "Saturdays:", es: "Sábados:", pt: "Sábados:" },
      contact_tz: { en: "EST Time (Eastern US)", es: "Horario EST (Este de EE. UU.)", pt: "Horário EST (Leste dos EUA)" },
      contact_process_title: { en: "Work Process", es: "Proceso de Trabajo", pt: "Processo de Trabalho" },
      process_1: { en: "Initial consultation", es: "Consulta inicial", pt: "Consulta inicial" },
      process_2: { en: "Analysis and planning", es: "Análisis y planificación", pt: "Análise e planejamento" },
      process_3: { en: "Detailed proposal", es: "Propuesta detallada", pt: "Proposta detalhada" },
      process_4: { en: "Iterative development", es: "Desarrollo iterativo", pt: "Desenvolvimento iterativo" },
      process_5: { en: "Delivery and support", es: "Entrega y soporte", pt: "Entrega e suporte" },
      about_title: { en: "About ProtonLab", es: "Acerca de ProtonLab", pt: "Sobre a ProtonLab" },
      about_lead: { en: "More than a development company, we are an innovation laboratory where ideas take shape.", es: "Más que una empresa de desarrollo, somos un laboratorio de innovación donde las ideas toman forma.", pt: "Mais do que uma empresa de desenvolvimento, somos um laboratório de inovação onde as ideias ganham forma." },
      about_phil_title: { en: "Our Philosophy", es: "Nuestra Filosofía", pt: "Nossa Filosofia" },
      about_phil_desc: { en: "We believe in the intersection of software and hardware as the future of technology. Every project is an opportunity to create something unique and meaningful that solves real problems and improves the user experience.", es: "Creemos en la intersección entre software y hardware como el futuro de la tecnología. Cada proyecto es una oportunidad para crear algo único y significativo que resuelva problemas reales y mejore la experiencia del usuario.", pt: "Acreditamos na interseção de software e hardware como o futuro da tecnologia. Cada projeto é uma oportunidade de criar algo único e significativo que resolva problemas reais e melhore a experiência do usuário." },
      about_method_title: { en: "Methodology", es: "Metodología", pt: "Metodologia" },
      about_method_desc: { en: "We combine agile development with solid engineering principles. We prioritize transparent communication and iterative value delivery, ensuring that each stage of the project is aligned with the client's objectives.", es: "Combinamos desarrollo ágil con principios de ingeniería sólidos. Priorizamos la comunicación transparente y la entrega iterativa de valor, asegurando que cada etapa del proyecto esté alineada con los objetivos del cliente.", pt: "Combinamos desenvolvimento ágil com princípios sólidos de engenharia. Priorizamos a comunicação transparente e a entrega iterativa de valor, garantindo que cada etapa do projeto esteja alinhada aos objetivos do cliente." },
      about_tech_title: { en: "Technologies", es: "Tecnologías", pt: "Tecnologias" },
      about_tech_desc: { en: "We work with a modern and versatile technology stack, always selecting the right tool for each specific challenge. We stay updated with the latest trends and best practices in the industry.", es: "Trabajamos con un stack tecnológico moderno y versátil, seleccionando siempre la herramienta adecuada para cada desafío específico. Mantenemos actualizados con las últimas tendencias y mejores prácticas de la industria.", pt: "Trabalhamos com uma stack tecnológica moderna e versátil, selecionando sempre a ferramenta certa para cada desafio específico. Mantemo-nos atualizados com as últimas tendências e melhores práticas do setor." },
      about_quality_title: { en: "Commitment to Quality", es: "Compromiso con la Calidad", pt: "Compromisso com a Qualidade" },
      about_quality_desc: { en: "At ProtonLab, we don't just deliver code; we deliver solutions that work, scale, and endure. Our commitment is to technical excellence and customer satisfaction in every project we undertake, ensuring that every line of code and every physical component meets the highest quality standards.", es: "En ProtonLab, no entregamos solo código; entregamos soluciones que funcionan, escalan y perduran. Nuestro compromiso es con la excelencia técnica y la satisfacción del cliente en cada proyecto que emprendemos, asegurando que cada línea de código y cada componente físico cumplan con los más altos estándares de calidad.", pt: "Na ProtonLab, não entregamos apenas código; entregamos soluções que funcionam, escalam e duram. Nosso compromisso é com a excelência técnica e a satisfação do cliente em cada projeto que realizamos, garantindo que cada linha de código e componente físico atenda aos mais altos padrões de qualidade." },
      footer_text: { en: "Innovation in every line of code, precision in every physical component.", es: "Innovación en cada línea de código, precisión en cada componente físico.", pt: "Inovação em cada linha de código, precisão em cada componente físico." },
      pay_modal_title: { en: "Payment Access", es: "Acceso a Pagos", pt: "Acesso a Pagamentos" },
      ...
      float_gallery: { en: "Gallery", es: "Galería", pt: "Galeria" },
      debug_editor_title: { en: "Code Editor", es: "Editor de Código", pt: "Editor de Código" },
      debug_analysis: { en: "Analysis", es: "Análisis", pt: "Análise" },
      debug_verifying: { en: "verifying...", es: "verificando...", pt: "verificando..." },
      debug_btn_analyze: { en: "Analyze", es: "Analizar", pt: "Analisar" },
      debug_placeholder: { en: "💡 Write your code and press \"Analyze\"", es: "💡 Escribe tu código y presiona \"Analizar\"", pt: "💡 Escreva seu código e pressione \"Analisar\"" },
      debug_analyzing_txt: { en: "Analyzing code...", es: "Analizando código...", pt: "Analisando código..." },
      ...
      ai_greeting: {
        ...
        pt: "Olá! Sou o RickGPT, seu assistente de IA especializado em desenvolvimento de software e hardware. Como posso ajudar hoje?"
      },
      ...
      debug_editor_example: {
        ...
        pt: `// Escreva ou cole seu código aqui\n// Exemplo em JavaScript:\n\nfunction factorial(n) {\n  if (n === 1) {\n    return 1;\n  }\n  return n * factorial(n - 1);\n}\n\nconsole.log(factorial(5));`
      },
      visits: {
        en: "TOTAL VISITS",
        es: "VISITAS TOTALES",
